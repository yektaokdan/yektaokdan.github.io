!(function (e, t) {
  ...
  return (function (e) {
    ...
    function (e, t, i) {
      ...
      const n = (e) => e[Math.floor(Math.random() * e.length)];
      function s(e, t) {
        return (
          null == e && (e = 0),
          null == t && (t = 1),
          ...
          try {
            ...
            return (
              ...
              void (
                ...
                (this.el.style.background = Object(o.b)(
                  this.options.backgroundColor
                )))
              )
            );
    ...
    function (e, t, i) {
      ...
      class s extends o.b {
        constructor(e) {
          (n = e.THREE || n),
            (n.Color.prototype.toVector = function () {
        ...
        init() {
          (this.mode = "shader"),
            (this.uniforms = {
              ...
              iResolution: { type: "v2", value: new n.Vector2(1, 1) },
        ...
        initBasicShader(e = this.fragmentShader, t = this.vertexShader) {
          ...
          const s = new n.Mesh(new n.PlaneGeometry(2, 2), i);
          this.scene.add(s),
          ...
          for (t in this.options)
            (i = this.options[t]),
              -1 !== t.toLowerCase().indexOf("color")
                ? (e[t] = { type: "v3", value: new n.Color(i).toVector() })
