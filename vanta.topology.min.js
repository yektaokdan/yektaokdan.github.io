!(function (t, e) {
  ...
  return (function (t) {
    ...
    0: function (t, e, i) {
      ...
      function l(t) {
        for (; t.children && t.children.length > 0; )
          l(t.children[0]), t.remove(t.children[0]);
    ...
    15: function (t, e, i) {
        ...
        onInit() {
          ...
          new n(function (e) {
            ...
            function g(t, i, s) {
              ...
              for (let a = 0; a < 100; a++) {
                let c = (a / 100) * e.TAU,
                  u = e.createVector(t + e.cos(c) * s, i + e.sin(c) * s),
                  l = e.noise(u.x, u.y);
                l > o && ((o = l), (r.x = u.x), (r.y = u.y)),
            ...
            (e.setup = function () {
              t.initP5(e),
                ...
                (function () {
                  for (let t = 0; t < p; t++) {
                    let i = e.random(e.width + 2 * r),
                      s = e.random(e.height + 2 * r);
                    f.push({
                      prev: e.createVector(i, s),
                      pos: e.createVector(i, s),
                ...
                (function () {
                  for (let t = 0; t < l; t++) {
                    let e = [];
                    for (let i = 0; i < u; i++) e.push(g(i * a, t * a, c));
                    d.push(e);
                  }
                })();
            }),
                ...
                e.translate(-r, -r),
                  (function () {
                    for (let t = 0; t < p; t++) {
                      ...
                      (i.prev.x = i.pos.x),
                        (i.prev.y = i.pos.y),
                        (i.pos.x = y(i.pos.x + i.vel.x, e.width + 2 * r)),
                        (i.pos.y = y(i.pos.y + i.vel.y, e.height + 2 * r)),
                        i.vel.add(i.acc).normalize().mult(2.2),
                  ...
                  (function () {
                    e.strokeWeight(1),
                      e.stroke(Object(o.c)(t.options.color, 0.05));
      ...
      r.initClass(), (e.default = s.a.register("TOPOLOGY", r));
    },
    3: function (t, e, i) {
      "use strict";
      i.d(e, "b", function () {
        ...
        initP5(t) {
          ...
          i.parent(e.el),
            e.applyCanvasStyles(t.canvas, {
              background: Object(o.b)(e.options.backgroundColor),
            }),
            (e.p5renderer = i),
            (e.p5canvas = t.canvas),
            (e.p5 = t);
